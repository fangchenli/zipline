...
class BcolzMinuteBarTestCase(WithTradingCalendars,
    ...
    def init_class_fixtures(cls):
        ...
        sessions = slice(TEST_CALENDAR_START, TEST_CALENDAR_STOP)
        cls.market_opens = cls.trading_calendar.first_minutes.loc[sessions]
        cls.market_closes = cls.trading_calendar.last_minutes.loc[sessions]
    ...
    def test_append_on_new_day(self):
        ...
        cday = self.trading_calendar.day
    ...
    def test_unadjusted_minutes_early_close(self):
        ...
        start_minute_loc = \
            self.trading_calendar.minutes.get_loc(minutes[0])
        minute_locs = [
            self.trading_calendar.minutes.get_loc(minute)
            - start_minute_loc
    ...
    def test_adjust_non_trading_minutes(self):
        ...
        dts = array(self.trading_calendar.sessions_minutes(
    ...
    def test_truncate_between_data_points(self):
        ...
        _, last_close = cal.session_first_last_minute(days[0])
    ...
    def test_truncate_all_data_points(self):
        ...
        cal = self.trading_calendar
        _, last_close = cal.session_first_last_minute(
            self.test_calendar_start)
        self.assertEqual(self.reader.last_available_dt, last_close)
