...
from numpy import arange, array, full, int64, repeat, tile
...
"""
    ...
    def test_history_sid_minute(self):
        ...
        self.assertEqual(
            window.loc["2016-01-26 22:32", cf],
            0,
        ...
        self.assertEqual(
            window.loc["2016-01-26 23:00", cf],
            0,
            "Should be FOF16 on on minute before roll minute.",
        )

        self.assertEqual(
            window.loc["2016-01-26 23:01", cf],
            1,
        ...
        self.assertEqual(
            window.loc["2016-01-27 22:32", cf],
            1,
            "Should be FOG16 at beginning of window.",
        )

        self.assertEqual(
            window.loc["2016-01-27 23:01", cf],
            1,
    ...
    def test_history_close_minute(self):
        ...
        self.assertEqual(
            window.loc["2016-02-25 22:32", cf],
            115231.412,
        ...
        self.assertEqual(
            window.loc["2016-02-25 23:00", cf],
            115231.440,
            "Should be FOG16 on on minute before roll minute.",
        )

        self.assertEqual(
            window.loc["2016-02-25 23:01", cf],
            125240.001,
