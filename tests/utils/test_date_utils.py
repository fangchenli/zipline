...
class TestDateUtils(ZiplineTestCase):
    ...
    def test_compute_date_range_chunks_invalid_input(self):
        ...
        assert str(cm.value) == "'Start date 2017-05-07 is not found in calendar.'"
        ...
        assert str(cm.value) == "'End date 2017-05-27 is not found in calendar.'"
        ...
        assert (
            str(cm.value) == "End date 2017-05-01 cannot precede start date 2017-06-01."
        )
