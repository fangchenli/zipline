...
def log_nyse_close(context, data):
    ...
    def test_future_symbol(self):
        ...
        self.assertEqual(cl.expiration_date, pd.Timestamp("2006-01-20"))
...
"""
        ...
        self.assertEqual(
            algo.capital_change_deltas, {pd.Timestamp("2006-01-06"): 50000.0}
        )
...
"""
        ...
        if change_loc == "interday":
            self.assertEqual(
                algo.capital_change_deltas, {pd.Timestamp("2006-01-04"): 1000.0}
            )
        else:
            self.assertEqual(
