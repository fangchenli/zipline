...
from pandas import DataFrame, Int64Index, Timestamp, concat
...
from zipline.testing import MockDailyBarReader, seconds_to_timestamp, str_to_seconds
...
class USEquityPricingLoaderTestCase(WithAdjustmentReader, ZiplineTestCase):
    ...
    def test_load_adjustments_to_df(self, convert_dts):
        ...
        assert_frame_equal(
            adjustment_dfs[div_name], create_expected_div_table(DIVIDENDS, div_name)
        )
