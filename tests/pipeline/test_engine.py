...
from zipline.pipeline.data import Column, DataSet, EquityPricing, USEquityPricing
...
class PopulateInitialWorkspaceTestCase(
    ...
    def test_populate_initial_workspace(self, window_length, pipeline_length):
        ...
        pipline_config = {
            ...
            "depends_on_precomputed_term_with_window": depends_on_precomputed_term_with_window,  # noqa: E501
            "depends_on_window_of_precomputed_term": depends_on_window_of_precomputed_term,  # noqa: E501
        }
