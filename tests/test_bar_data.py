...
class TestMinuteBarData(
    ...
    def test_get_value_is_unadjusted(self):
        ...
        split = splits[0]
        self.assertEqual(split[0], pd.Timestamp("2016-01-06"))
...
class TestDailyBarData(
    ...
    def get_last_minute_of_session(self, session_label):
        return self.trading_calendar.session_first_last_minute(session_label)[1]
    ...
    def test_get_value_adjustments(
        ...
        self.assertEqual(adjustment[0], pd.Timestamp("2016-01-06"))
