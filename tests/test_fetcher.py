...
def handle_data(context, data):
    ...
    record(cpi=cur_cpi)
        ...
        self.assertEqual(results["cpi"].iloc[-1], 203.1)
...
def handle_data(context, data):
    record(
        ...
        self.assertEqual(5, results["signal"].iloc[-1])
        self.assertEqual(50, results["scaled"].iloc[-1])
        self.assertEqual(24, results["price"].iloc[-1])  # fake value
...
def handle_data(context, data):
    ...
    def test_fetcher_universe(self, name, data, column_name):
        ...
        with patch(
            ...
            sim_params = factory.create_simulation_parameters(
                start=pd.Timestamp("2006-01-09"), end=pd.Timestamp("2006-01-11")
            )
...
def handle_data(context, data):
    ...
    def test_fetcher_universe_non_security_return(self):
        ...
        sim_params = factory.create_simulation_parameters(
            start=pd.Timestamp("2006-01-09"), end=pd.Timestamp("2006-01-10")
        )
