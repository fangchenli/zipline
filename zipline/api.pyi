...
from zipline.algorithm import OnError
...
def get_environment(field: str = "platform") -> Any:
...
def history(bar_count: int, frequency: str, field: str, ffill: bool = True) -> Any:
...
def symbols(*args: str, **kwargs: Any) -> list[Equity]:
