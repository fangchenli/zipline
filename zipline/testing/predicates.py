...
from zipline.utils.numpy_utils import assert_array_compare, compare_datetime_arrays
...
def assert_timestamp_and_datetime_equal(
    ...
    **kwargs,
    ...
    assert allow_datetime_coercions or type(result) == type(expected), err_msg
